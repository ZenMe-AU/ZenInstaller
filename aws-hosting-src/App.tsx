        ...
        <Box sx={{ maxWidth: 860, mx: "auto", px: 4, py: 5 }}>
          ...
          >
            <Typography sx={{ fontSize: "0.85rem", color: "#475569", lineHeight: 1.7, fontFamily: "'IBM Plex Sans', sans-serif" }}>
              ZenInstaller AWS Hosting configures AWS Entra SSO and CloudFront infrastructure for your Zenblox environment.
            </Typography>
          </Box>
...
export default withAITracking(reactPlugin, AppDashboard, "awsHostingInstaller");
