...
$archivePath = Join-Path $outputDirectory 'zeninstaller-playwright-coverage-0.1.4.vsix'
...
try {
    foreach ($name in @('package.json', 'extension.cjs', 'coverage.cjs', 'live-run.cjs', 'progress-reporter.cjs', 'README.md')) {
    ...
    $metadata = @{
        ...
        'extension.vsixmanifest' = '<PackageManifest Version="2.0.0" xmlns="http://schemas.microsoft.com/developer/vsx-schema/2011"><Metadata><Identity Language="en-US" Id="zeninstaller-playwright-coverage" Version="0.1.4" Publisher="zeninstaller"/><DisplayName>ZenInstaller Playwright Coverage</DisplayName><Description xml:space="preserve">Display Playwright Istanbul coverage in VS Code.</Description><Tags>testing,coverage</Tags><Categories>Testing</Categories><GalleryFlags>Public</GalleryFlags><Properties><Property Id="Microsoft.VisualStudio.Code.Engine" Value="^1.93.0"/></Properties></Metadata><Installation><InstallationTarget Id="Microsoft.VisualStudio.Code"/></Installation><Dependencies/><Assets><Asset Type="Microsoft.VisualStudio.Code.Manifest" Path="extension/package.json" Addressable="true"/></Assets></PackageManifest>'
    }
