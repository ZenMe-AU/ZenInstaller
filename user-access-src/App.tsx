        ...
        <Box sx={{ maxWidth: 860, mx: "auto", px: 4, py: 5 }}>
          ...
          >
            <Typography sx={{ fontSize: "0.85rem", color: "#475569", lineHeight: 1.7, fontFamily: "'IBM Plex Sans', sans-serif" }}>
              ZenInstaller User Access configures user groups and account access for your Zenblox environment.
            </Typography>
          </Box>
...
export default withAITracking(reactPlugin, AppDashboard, "userAccessInstaller");
