...
6. When creating a new integration test, use the AzureSubscriptionCard.spec.ts integration test as example where expected user interaction is the "Happy Path", but also check for standards from the other integration tests.
